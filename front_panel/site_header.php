...
<body class="bg-light">
    <div class="container">
        <div class="row">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary my-3 rounded">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form class="form-inline my-2 my-lg-0" method="post" action="<?php echo $url; ?>/search.php">
                            <input class="form-control mr-sm-2" type="search" name="search_Key" placeholder="Search"
                                aria-label="Search">
            ...
            <div class="col-12 ">
                <?php foreach (adsShow() as $ad){ ?>
                <a href="<?php echo $ad['link'];?>" target="_blink">
                    <img src="<?php echo $ad['photo'] ; ?>" class="w-100 rounded shadow-sm mb-3" alt="">
                </a>
                <?php } ?>
            </div>
        </div>
